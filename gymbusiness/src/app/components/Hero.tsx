...
export default function Hero() {
    return (
        <section
            id="hero"
            className="relative bg-hero-image bg-cover bg-center py-20 sm:py-28 md:py-32 transition-colors duration-300"
        >
            {/* Overlay oscuro con modo claro/oscuro */}
            <div className="absolute inset-0 bg-black/50 dark:bg-black/70 backdrop-brightness-90 dark:backdrop-brightness-75 z-0" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center lg:items-start justify-between">
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left">
                    ...
                    <p className="text-base sm:text-lg md:text-xl mb-10 text-white max-w-lg mx-auto lg:mx-0">
